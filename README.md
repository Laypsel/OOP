...
<p>Використати патерн Стан для реалізації стану можливості редагування, додавання та видалення товарів у коді (code2.ts). IProductState - інтерфейс стану товарів. Створенно класи для кожного зі станів та також клас ProductCatalog визначає стан для товару та делегує виконання дій до відповідного об'єкта стану.</p>
